...
import { ShieldCheck, Cpu, Globe, Users, Award, Zap, Sparkles } from "lucide-react";
      ...
      <section className="py-24 bg-[#070A0F] font-sans border-b border-pan-dark-border">
        <div className="container-page grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {corePillars.map((item, idx) => (
            <div
              key={idx}
              className="rounded-2xl bg-[#0F141E] border border-pan-dark-border p-8 hover:border-pan-orange/50 transition flex flex-col justify-between"
            >
              <div>
                <div className="h-12 w-12 rounded-xl bg-pan-orange/10 border border-pan-orange/30 text-pan-orange flex items-center justify-center mb-6">
