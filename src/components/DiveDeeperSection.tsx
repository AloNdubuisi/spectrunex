...
const slides: DiveSlide[] = [
  ...
  },
  {
    ...
    body: "Unify network security across hardware, virtual, and cloud-native deployments — shared policy, consistent segmentation, and threat prevention designed, deployed, and maintained by Spectrunex engineers.",
    ctaLabel: "Learn more",
    ctaHref: "/contact",
  },
  {
  ...
  },
  {
    ...
    body: "Secure distributed work without slowing it down. Spectrunex designs remote-access and edge architectures that protect users, applications, and data while keeping day-to-day operations straightforward to run.",
    ctaLabel: "Learn more",
    ctaHref: "/contact",
  },
  {
